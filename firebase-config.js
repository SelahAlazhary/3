// ============================================
//  إعدادات Firebase - ملف منفصل
//  ملاحظة أمنية مهمة: مفاتيح Firebase في تطبيقات الويب تكون ظاهرة دائماً
//  للمتصفح بطبيعتها، فصلها في ملف لا يخفيها فعلياً. الحماية الحقيقية
//  تكون عبر "قواعد الأمان Security Rules" في لوحة تحكم Firebase.
// ============================================
